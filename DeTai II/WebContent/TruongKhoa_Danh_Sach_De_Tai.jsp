...
<sql:query dataSource="${DBConn}" var="result">
                select detai.MaDeTai,detai.TenDeTai, sinhvien.HoTen
				from sinhvien,detai
				where  detai.MaSV=sinhvien.MSSV 
         </sql:query>
		...
		<div class="row">
			...
			<div class="col-md-9 well">
						...
						<tbody>
							<c:forEach var="rows" items="${result.rows }">
								<tr>
									...
									<td><a
										href=" TruongKhoa _Danh_Sach_De_Tai_Chi_Tiet.jsp?MaDeTai=${rows.MaDeTai}"
										class="btn btn-info" role="button">Chi Tiết</a></td>
								</tr>
							</c:forEach>
						</tbody>
				...
				<div class="form-group"
					...
					<a href=" TruongKhoa_Home.jsp " class="btn btn-info" role="button">
						BACK </a>
				</div>
			</div>
		</div>
