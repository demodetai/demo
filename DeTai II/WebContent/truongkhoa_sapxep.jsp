...
<sql:query dataSource="${DBConn}" var="result">
                select detai.MaDeTai,detai.TenDeTai, sinhvien.HoTen, sinhvien.MSSV
				from sinhvien,detai
						...
						<tbody>
							<c:forEach var="rows" items="${result.rows }">
								<tr>
									...
									<td><a
										href="truongkhoa_sapxep_2.jsp?MaDeTai=${rows.MaDeTai} "
										class="btn btn-info" role="button">Sắp Xếp</a></td>
								</tr>
							</c:forEach>
