...
<%
        ...
        %>
<sql:query dataSource="${DBConn}" var="result"> select * from giaovien where MSGV=<%=tk.getId_TK()%>;</sql:query>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-4 well">
				...
				<div style="text-align: center;">
					<br> <a href="GV_Doi_MK.jsp" class="btn btn-info"
						role="button">Đổi MK</a> <a href="GV_Doi_Thong_Tin.jsp"
